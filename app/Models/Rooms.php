...
class Rooms extends Model {
	...
	protected $appends = ['steps_count', 'property_type_name', 'room_type_name', 'bed_type_name', 'photo_name', 'host_name', 'reviews_count', 'overall_star_rating', 'reviews_count_lang', 'bed_lang','popup_price'];
