                ...
                <div class="container_puzkdo">
                    ...
                    <div data-id="SearchBarSmall" class="container_1tvwao0">
                      <div class="container_mv0xzc" style="width: 100%;">
                        ...
                        <button type="button" class="button_1b5aaxl button-sm-search">
                          ...
                          <span class="copy_14aozyc">{{ trans('messages.header.anywhere') }} · {{ trans('messages.header.anytime') }} · 1 {{ trans('messages.header.guest') }}</span>
                        </button>
                        <div class="focusUnderline_7131v4"></div>
                      </div></div><!-- react-empty: 29505 -->
                    </div>
                  </div></div>
                 ...
                 <div class="lazy-load-div1 lazy-load1 col-md-12 col-lg-12 col-sm-12 col-xs-12  p-0" id="lazy_load_slider">
                  ...
                  <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 nwt_slid p-0" ng-if="reservation.length > 0">
                   ...
                   <div class="home-bx-slider1 col-md-12 col-lg-12 col-sm-12 col-xs-12 " style="position:relative;padding:0px;" >
                     <div class="row cate1">
                      <div class="cateimg" ng-repeat="(key, fetch_data) in reservation" ng-if="key<=7">
                        <div class="col-md-3">
                          ...
                          <div class="panel-body panel-card-section">
                            <div class="media">
                              ...
                              <div itemprop="description" class="pull-left text-muted rt_set listing-location text-truncate">
                                ...
                                <a href="@{{ url+fetch_data.room_id }}" class="text-normal link-reset">
                  ...
                  <div class="seeMoreContainer_11b8zgn">
                    <a href="{{ url('s') }}" ng-if="reservation.length > 8">
                     <button class="button_ops1o9-o_O-text_13lu1ne-o_O-button_flushRight_s5eog0">
                       ...
                       <svg viewBox="0 0 18 18" role="presentation" aria-hidden="true" focusable="false" style="fill: currentcolor; height: 10px; width: 10px;color: #008489;"><path fill-rule="evenodd" d="M4.293 1.707A1 1 0 1 1 5.708.293l7.995 8a1 1 0 0 1 0 1.414l-7.995 8a1 1 0 1 1-1.415-1.414L11.583 9l-7.29-7.293z"></path></svg>
                     </button></a>
                   </div>
                 </div>
                 ...
                 <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 nwt_slid p-0" ng-if="recommented.length >0">
                  ...
                  <div class="home-bx-slider1 col-md-12 col-lg-12 col-sm-12 col-xs-12 " style="position:relative;padding:0px;">
                    ...
                    <div class="row cate2">
                      <div class="cateimg" ng-repeat="(key,reservation) in recommented" ng-if="key<=7">
                        <div class="col-md-3">
                          <a href=" @{{ url+reservation.id }}">
                            <img ng-src="@{{ reservation.photo_name }}" />
                          </a>
                          <div class="panel-body panel-card-section">
                            <div class="media">
                              <div class="category_city hm_cate">
                              ...
                              <div class="exp_price">
                                <span ng-bind-html="reservation.rooms_price.currency.symbol">
                                </span>
                              ...
                              <div itemprop="description" class="rt_set pull-left text-muted listing-location text-truncate">
                                <a href="" class="text-normal link-reset pull-left">
                                  ...
                                  <span class="pull-left" style="padding-left: 5px;color:#555;">
                                    <a href=" @{{ url+reservation.id }}">
                                      ...
                                      <span ng-if="reservation.overall_star_rating" class="pull-left r-label ng-binding" style="color:#555;">
                  ...
                  <div class="seeMoreContainer_11b8zgn">
                    <a href="{{ url('s') }}" ng-if="recommented.length > 8">
                      <button class="button_ops1o9-o_O-text_13lu1ne-o_O-button_flushRight_s5eog0">
                        <span class="text_13lu1ne"> 
                          <span>{{ trans('messages.header.seeall') }}</span>
                        </span>
                        <svg viewBox="0 0 18 18" role="presentation" aria-hidden="true" focusable="false" style="fill: currentcolor; height: 10px; width: 10px;color: #008489;">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 nwt_slid p-0" ng-if="most_viewed.length > 0">
                  ...
                  <div class="home-bx-slider col-md-12 col-lg-12 col-sm-12 col-xs-12 " style="position:relative;padding:0px;">
                    <div class="row cate3">
                      ...
                      <div class="cateimg" ng-repeat="(key,view_count) in most_viewed" ng-if="key<=7">
                        <div class="col-md-3">
                          <a href=" @{{ url+view_count.id }}">
                            <img ng-src="@{{ view_count.photo_name}}" />
                          </a>
                          <div class="panel-body panel-card-section">
                            <div class="media">
                              <div class="category_city hm_cate">
                              ...
                              <div itemprop="description" class="rt_set pull-left text-muted listing-location text-truncate">
                                ...
                                <a href=" @{{ url+view_count.id }}" class="text-normal link-reset">
                  ...
                  <div class="seeMoreContainer_11b8zgn">
                    <a href="{{ url('s') }}" ng-if="most_viewed.length > 8">
                      <button class="button_ops1o9-o_O-text_13lu1ne-o_O-button_flushRight_s5eog0">
                        <span class="text_13lu1ne"><span>{{ trans('messages.header.seeall') }}</span> </span>
                        <svg viewBox="0 0 18 18" role="presentation" aria-hidden="true" focusable="false" style="fill: currentcolor; height: 10px; width: 10px;color: #008489;"><path fill-rule="evenodd" d="M4.293 1.707A1 1 0 1 1 5.708.293l7.995 8a1 1 0 0 1 0 1.414l-7.995 8a1 1 0 1 1-1.415-1.414L11.583 9l-7.29-7.293z"></path></svg>
                      </button>
