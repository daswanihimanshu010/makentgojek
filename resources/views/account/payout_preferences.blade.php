...
<!-- <div class="space-top-4 space-4">
  <a href="{{ url('invite?r=5') }}" class="btn btn-block">Invite Friends</a>
    ...
    <div class="col-md-9">
<div class="" id="payout_setup" ng-init="payout_delete_url = '{{ url('/') }}/users/payout_delete/';payout_default_url = '{{ url('/') }}/users/payout_default/'">
            ...
            <tr>
              ...
              <li class="dropdown-trigger list-unstyled">
                  ...
                  <ul data-sticky="true" data-trigger="#payout-options-{{ $row->id }}" class="tooltip tooltip-top-left list-unstyled dropdown-menu" aria-hidden="true">
                    <li>
                      <a rel="nofollow" data-method="post" class="payout_options link-reset menu-item" ng-click="disablePayoutOption($event,payout_delete_url,{{ $row->id }})" style="cursor:default">{{ trans('messages.account.remove') }}</a>
                    </li>
                    <li>
                      <a rel="nofollow" data-method="post" class="payout_options link-reset menu-item" ng-click="disablePayoutOption($event,payout_default_url,{{ $row->id }})" style="cursor:default">{{ trans('messages.account.set_default') }}</a>
                    </li>
                  </ul>
              </li>
              @endif        
...
<ul data-sticky="true" data-trigger="#payout-options-{{ $row->id }}" class="tooltip tooltip-top-left list-unstyled dropdown-menu" aria-hidden="true" role="tooltip" style="left: 1019.45px; top: 232.967px;">
  @if($row->default != 'yes')
  <li>
    <a rel="nofollow" data-method="post" class="payout_options link-reset menu-item" ng-click="disablePayoutOption($event,payout_delete_url,{{ $row->id }})">{{ trans('messages.account.remove') }}</a>
  </li>
  @endif
  <li>
    <a rel="nofollow" data-method="post" class="payout_options link-reset menu-item" ng-click="disablePayoutOption($event,payout_default_url,{{ $row->id }})">{{ trans('messages.account.set_default') }}</a>
  </li>
</ul>
@endforeach
@stop
